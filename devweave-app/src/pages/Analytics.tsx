  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/[0.08] pb-5">
        <div>
          ...
          <p className="text-sm text-white/60 mt-1">
            DORA metrics, lead time for changes, deployment frequency, and MTTR insights.
          </p>
        </div>
      </div>
      ...
      <GlassCard className="p-8 text-center space-y-4 max-w-2xl mx-auto my-12">
        ...
        <h3 className="text-lg font-semibold text-white">Analytics Module</h3>
        <p className="text-sm text-white/60 max-w-md mx-auto leading-relaxed">
          This module is being built. Platform productivity insights and DORA metric tracking will be available in the next development phase.
        </p>
        <div className="pt-2 flex justify-center items-center gap-4 text-xs text-white/40">
          <span className="inline-flex items-center gap-1.5">
            <TrendingUp className="h-3.5 w-3.5" /> DORA Framework
          </span>
          <span className="inline-flex items-center gap-1.5">
            <Clock className="h-3.5 w-3.5" /> Cycle Time Trends
          </span>
        </div>
      </GlassCard>
    </div>
