...
export type StorageHash =
  StorageHashBase<'042a810bbbdb58c8a5897e71515dd5d423f8dc54ba660f1b9178d941a9ad70de'>;
export type ExecutionHash =
  ExecutionHashBase<'1b93e24c1503fcb5ea7bd07822b609669e0f6b22cad6529654bea4e4f117b2a1'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly GitHubIntegration: {
      ...
      readonly githubUserId: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly GitHubIntegration: {
      ...
      readonly githubUserId: CodecTypes['pg/text@1']['input'];
          ...
          readonly table: {
            readonly gitHubIntegration: {
              ...
              uniques: readonly [
                ...
                { readonly columns: readonly ['githubUserId'] },
              ];
              indexes: readonly [];
              foreignKeys: readonly [
                {
                  readonly source: {
                    ...
                    readonly tableName: 'gitHubIntegration';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
...
> & {
  ...
  readonly roots: {
    ...
    readonly gitHubIntegration: {
      ...
      readonly model: 'GitHubIntegration';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          readonly GitHubIntegration: {
            ...
            readonly storage: {
              readonly table: 'gitHubIntegration';
